                ...
                <form onSubmit={handleSubmit}>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                        <div className="flex flex-col gap-1">
                            <label className="block text-xs font-semibold text-slate-700 uppercase tracking-wider mb-1">Data da Compra</label>
                            <input
                                type="date"
                                name="date"
                                className={inputCls}
                        ...
                        <div className="flex flex-col gap-1">
                            <label className="block text-xs font-semibold text-slate-700 uppercase tracking-wider mb-1">Fornecedor</label>
                            <select
                                name="supplierId"
                                className={selectCls}
                    ...
                    {purchase.items.map((item, index) => (
                        <div key={index} className="bg-stone-50 border border-slate-200 rounded-lg p-4 mb-3">
                            <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 items-end">
                                ...
                                <div className="flex flex-col gap-1">
                                    <label className="block text-xs font-semibold text-slate-700 uppercase tracking-wider mb-1">Quantidade</label>
                                    <input
                                        type="number"
                                        name="quantity"
                                        min="1"
                    ...
                    <button
                        type="button"
                        className="px-4 py-2 border border-slate-300 text-slate-700 text-sm font-semibold rounded-lg hover:bg-stone-50 transition-colors flex items-center gap-2 mt-2"
